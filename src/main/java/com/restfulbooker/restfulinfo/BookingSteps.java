...
package com.restfulbooker.restfulinfo;
...
public class BookingSteps {
    ...
    public ValidatableResponse updateStudent(int bookingID, String firstName, String lastName, int totalPrice, boolean depositPaid, BookingDates bookingDate, String additionalNeeds) {
        BookingPojo bookingPojo = BookingPojo.getBookingPojo(firstName, lastName, totalPrice, depositPaid, bookingDate, additionalNeeds);
